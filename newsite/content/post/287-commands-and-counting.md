...
Really, I said all that so that you'd hopefully excuse the recent lack of communication 😊 Not only did I have the big ol' audit, but we are also preparing for two dbatools pre-cons. One with [Klaas Vandenberghe](https://www.powerdba.eu/) and [Rob Sewell](http://sqldbawithabeard.com) in [Ghent, Belgium at dataminds](https://sqlps.io/preconbe) and then the one in [Seattle at PASS Summit](https://sqlps.io/precon).
...
If you'd like to keep up with the latest releases and use Windows 10, consider [Watch-DbaUpdate](https://docs.dbatools.io/Watch-DbaUpdate). Note that [Install-DbatoolsWatchUpdate](https://docs.dbatools.io/Install-DbatoolsWatchUpdate) does require running as admin in order to automatically setup the scheduled task.

![watch1](https://dbatools.io/wp-content/uploads/2017/02/watch1.png)

### ttys

Once the webpages for these commands have been written, I'll do the formal, beautiful release of **[picklerick](http://rickandmorty.wikia.com/wiki/Pickle_Rick)**.
