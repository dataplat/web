...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaReplSubscription</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaReplSubscription.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1 -Database TestDB" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1 -PublicationName Mergey" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1 -Type Push" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1 -SubscriberName mssql2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplSubscription -SqlInstance mssql1 -SubscriptionDatabase TestDB" }
