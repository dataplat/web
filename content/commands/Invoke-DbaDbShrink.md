...
Want to see the source code for this command? Check out [Invoke-DbaDbShrink](https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbaDbShrink.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Invoke-DbaDbShrink](https://dataplat.github.io/boh#Invoke-DbaDbShrink).
