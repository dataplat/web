...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbUdf</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbUdf.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbUdf -SqlInstance localhost, sql2016 -Database db1, db2 -Name udf1, udf2, udf3" }
...
```
{: data-copyable="true" data-clean-code="$udfs = Get-DbaDbUdf -SqlInstance localhost, sql2016 -Database db1, db2 -Name udf1, udf2, udf3
$udfs | Remove-DbaDbUdf" }
