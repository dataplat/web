...
Want to see the source code for this command? Check out [Get-DbaDbBackupHistory](https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbBackupHistory.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Get-DbaDbBackupHistory](https://dataplat.github.io/boh#Get-DbaDbBackupHistory).
