...
<div class="command-header">
  <div class="command-header-top">
    <h1>Invoke-DbatoolsFormatter</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbatoolsFormatter.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Invoke-DbatoolsFormatter -Path C:\dbatools\public\Get-DbaDatabase.ps1" }
