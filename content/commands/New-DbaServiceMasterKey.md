...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaServiceMasterKey</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaServiceMasterKey.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaServiceMasterKey -SqlInstance Server1" }
