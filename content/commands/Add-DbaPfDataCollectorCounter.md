...
<div class="command-header">
  <div class="command-header-top">
    <h1>Add-DbaPfDataCollectorCounter</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Add-DbaPfDataCollectorCounter.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Add-DbaPfDataCollectorCounter -ComputerName sql2017 -CollectorSet 'System Correlation' -Collector DataCollector01  -Counter '\LogicalDisk(*)\Avg. Disk Queue Length'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPfDataCollector | Out-GridView -PassThru | Add-DbaPfDataCollectorCounter -Counter '\LogicalDisk(*)\Avg. Disk Queue Length' -Confirm" }
