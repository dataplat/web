...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbSchema</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbSchema.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbSchema -SqlInstance sqldev01 -Database example1 -Schema TestSchema1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sqldev01, sqldev02 -Database example1 | Remove-DbaDbSchema -Schema TestSchema1, TestSchema2" }
