...
<div class="command-header">
  <div class="command-header-top">
    <h1>Invoke-DbaDbDataGenerator</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbaDbDataGenerator.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaDbDataGenerator -SqlInstance sqldb2 -Database DB1 -FilePath C:\temp\sqldb1.db1.tables.json" }
