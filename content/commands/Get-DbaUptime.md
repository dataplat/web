...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaUptime</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaUptime.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaUptime -SqlInstance SqlBox1\Instance2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaUptime -SqlInstance winserver\sqlexpress, sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sql2014 | Get-DbaUptime" }
