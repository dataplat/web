...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbMailConfig</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbMailConfig.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailConfig -SqlInstance sql01\sharepoint" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailConfig -SqlInstance sql01\sharepoint -Name ProhibitedExtensions" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailConfig -SqlInstance sql01\sharepoint | Select-Object *" }
