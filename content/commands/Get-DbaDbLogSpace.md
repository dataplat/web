...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbLogSpace</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbLogSpace.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Jess Pomfret, JessPomfret.com</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbLogSpace -SqlInstance Server1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbLogSpace -SqlInstance Server1 -Database Database1, Database2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbLogSpace -SqlInstance Server1 -ExcludeDatabase Database3" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbLogSpace -SqlInstance Server1 -ExcludeSystemDatabase" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegisteredServer -SqlInstance cmsServer | Get-DbaDbLogSpace -Database Database1" }
