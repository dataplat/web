...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbRecoveryModel</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbRecoveryModel.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRecoveryModel -SqlInstance sql2014 -RecoveryModel BulkLogged -Verbose" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRecoveryModel -SqlInstance sql2014 -Database TestDB" }
