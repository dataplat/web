...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbMailAccount</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbMailAccount.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="$account = New-DbaDbMailAccount -SqlInstance sql2017 -Account 'The DBA Team' -EmailAddress admin@ad.local -MailServer smtp.ad.local" }
