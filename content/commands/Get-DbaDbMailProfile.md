...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbMailProfile</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbMailProfile.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailProfile -SqlInstance sql01\sharepoint" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailProfile -SqlInstance sql01\sharepoint -Profile 'The DBA Team'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailProfile -SqlInstance sql01\sharepoint | Select-Object *" }
...
```
{: data-copyable="true" data-clean-code="$servers = &quot;sql2014&quot;, &quot;sql2016&quot;, &quot;sqlcluster\sharepoint&quot;
Get-DbaDbMailProfile -SqlInstance $servers" }
