...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaClientProtocol</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaClientProtocol.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaClientProtocol -ComputerName sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="'sql1','sql2','sql3' | Get-DbaClientProtocol" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaClientProtocol -ComputerName sql1,sql2 | Out-GridView" }
...
```
{: data-copyable="true" data-clean-code="(Get-DbaClientProtocol -ComputerName sql2 | Where-Object { $_.DisplayName -eq 'Named Pipes' }).Disable()" }
