...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaLinkedServer</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaLinkedServer.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaLinkedServer -SqlInstance DEV01" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance DEV01 -Group SQLDEV | Get-DbaLinkedServer | Out-GridView" }
