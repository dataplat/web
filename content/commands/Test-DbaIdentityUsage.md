...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaIdentityUsage</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaIdentityUsage.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaIdentityUsage -SqlInstance sql2008, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaIdentityUsage -SqlInstance sql2008 -Database TestDB" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaIdentityUsage -SqlInstance sql2008 -Database TestDB -Threshold 20" }
