...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbSnapshot</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbSnapshot.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbSnapshot -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbSnapshot -SqlInstance sqlserver2014a -Database HR, Accounting" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbSnapshot -SqlInstance sqlserver2014a -Snapshot HR_snapshot, Accounting_snapshot" }
