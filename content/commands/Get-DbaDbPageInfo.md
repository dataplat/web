...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbPageInfo</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbPageInfo.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbPageInfo -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbPageInfo -SqlInstance sql2017, sql2016 -Database testdb" }
...
```
{: data-copyable="true" data-clean-code="$servers | Get-DbaDatabase -Database testdb | Get-DbaDbPageInfo" }
