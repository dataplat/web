...
<div class="command-header">
  <div class="command-header-top">
    <h1>Disconnect-DbaInstance</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Disconnect-DbaInstance.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaConnectedInstance | Disconnect-DbaInstance" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaConnectedInstance | Out-GridView -Passthru | Disconnect-DbaInstance" }
...
```
{: data-copyable="true" data-clean-code="$server = Connect-DbaInstance -SqlInstance sql01
