...
<div class="command-header">
  <div class="command-header-top">
    <h1>Export-DbaLogin</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Export-DbaLogin.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Export-DbaLogin -SqlInstance sql2005 -Path C:\temp\sql2005-logins.sql" }
...
```
{: data-copyable="true" data-clean-code="Export-DbaLogin -SqlInstance sqlserver2014a -ExcludeLogin realcajun -SqlCredential $scred -Path C:\temp\logins.sql -Append" }
...
```
{: data-copyable="true" data-clean-code="Export-DbaLogin -SqlInstance sqlserver2014a -Login realcajun, netnerds -Path C:\temp\logins.sql" }
...
```
{: data-copyable="true" data-clean-code="Export-DbaLogin -SqlInstance sqlserver2014a -Login realcajun, netnerds -Database HR, Accounting" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sqlserver2014a -Database HR, Accounting | Export-DbaLogin" }
...
Export-DbaLogin -SqlInstance sqlserver2008 -Login realcajun, netnerds -Path C:\temp\login.sql" }
...
```
{: data-copyable="true" data-clean-code="Export-DbaLogin -SqlInstance sqlserver2008 -Login realcajun -Path C:\temp\users.sql -DestinationVersion SQLServer2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sqlserver2008 -Login realcajun | Export-DbaLogin" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaLogin -SqlInstance sqlserver2008, sqlserver2012  | Where-Object { $_.IsDisabled -eq $false } | Export-DbaLogin" }
