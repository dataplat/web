...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaResourceGovernor</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaResourceGovernor.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Set-DbaResourceGovernor -SqlInstance sql2016 -Enabled" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaResourceGovernor -SqlInstance sql2012\dev1 -Disabled" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaResourceGovernor -SqlInstance sql2012\dev1 -ClassifierFunction 'fnRGClassifier' -Enabled" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaResourceGovernor -SqlInstance sql2012\dev1 -ClassifierFunction 'NULL' -Enabled" }
