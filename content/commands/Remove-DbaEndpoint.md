...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaEndpoint</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaEndpoint.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaEndpoint -SqlInstance sqlserver2012 -AllEndpoints" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaEndpoint -SqlInstance sqlserver2012 -Endpoint endpoint1,endpoint2 -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaEndpoint -SqlInstance sqlserver2012 -Endpoint endpoint1 | Remove-DbaEndpoint" }
