...
<div class="command-header">
  <div class="command-header-top">
    <h1>Measure-DbatoolsImport</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Measure-DbatoolsImport.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Measure-DbatoolsImport" }
...
PS C:\> Measure-DbatoolsImport
```
{: data-copyable="true" data-clean-code="Import-Module dbatools
Measure-DbatoolsImport" }
