...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbMailAccount</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbMailAccount.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbMailAccount -SqlInstance localhost, localhost\namedinstance" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbMailAccount -SqlInstance localhost -Account MyDatabaseMailAccount" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailAccount -SqlInstance SRV1 | Out-GridView -Title 'Select database mail account(s) to drop' -OutputMode Multiple | Remove-DbaDbMailAccount" }
