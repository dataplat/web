...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaAgentJobStep</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaAgentJobStep.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentJobStep -SqlInstance sql1 -Job Job1 -StepName Step1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentJobStep -SqlInstance sql1 -Job Job1 -StepName Step1 -Database msdb" }
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentJobStep -SqlInstance sql1, sql2, sql3 -Job Job1 -StepName Step1 -Database msdb" }
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentJobStep -SqlInstance sql1, sql2, sql3 -Job Job1, Job2, 'Job Three' -StepName Step1 -Database msdb" }
...
```
{: data-copyable="true" data-clean-code="sql1, sql2, sql3 | New-DbaAgentJobStep -Job Job1 -StepName Step1 -Database msdb" }
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentJobStep -SqlInstance sq1 -Job Job1 -StepName StepA -Database msdb -StepId 2 -Insert" }
