...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaLogin</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaLogin.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaLogin -SqlInstance sql2016 -Login mylogin" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaLogin -SqlInstance sql2016 -Login mylogin, yourlogin" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaLogin -SqlInstance sql2016 -Login mylogin -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaLogin -SqlInstance server\instance -Login yourlogin | Remove-DbaLogin" }
