...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaRegServer</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaRegServer.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaRegServer -SqlInstance sql2012 -Group HR, Accounting" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaRegServer -SqlInstance sql2012 -Group HR\Development" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaRegServer -SqlInstance sql2012 -Confirm:$false" }
