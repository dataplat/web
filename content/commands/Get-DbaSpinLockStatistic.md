...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaSpinLockStatistic</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaSpinLockStatistic.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaSpinLockStatistic -SqlInstance sql2008, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="$output = Get-DbaSpinLockStatistic -SqlInstance sql2008 | Select-Object * | ConvertTo-DbaDataTable" }
...
```
{: data-copyable="true" data-clean-code="'sql2008','sqlserver2012' | Get-DbaSpinLockStatistic" }
