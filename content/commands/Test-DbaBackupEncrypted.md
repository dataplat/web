...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaBackupEncrypted</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaBackupEncrypted.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaBackupEncrypted -SqlInstance sql01 -Path /tmp/northwind.bak" }
