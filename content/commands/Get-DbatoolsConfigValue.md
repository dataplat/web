...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbatoolsConfigValue</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbatoolsConfigValue.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbatoolsConfigValue -Name 'System.MailServer'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbatoolsConfigValue -Name 'Default.CoffeeMilk' -Fallback 0" }
