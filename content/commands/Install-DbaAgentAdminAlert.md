...
Want to see the source code for this command? Check out [Install-DbaAgentAdminAlert](https://github.com/dataplat/dbatools/blob/master/public/Install-DbaAgentAdminAlert.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Install-DbaAgentAdminAlert](https://dataplat.github.io/boh#Install-DbaAgentAdminAlert).
