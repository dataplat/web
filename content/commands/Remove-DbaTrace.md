...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaTrace</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaTrace.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaTrace -SqlInstance sql2008" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaTrace -SqlInstance sql2008 -Id 1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTrace -SqlInstance sql2008 | Out-GridView -PassThru | Remove-DbaTrace" }
