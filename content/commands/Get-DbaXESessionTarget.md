...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaXESessionTarget</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaXESessionTarget.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaXESessionTarget -SqlInstance ServerA\sql987 -Session system_health" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaXESession -SqlInstance sql2016 -Session system_health | Get-DbaXESessionTarget" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaXESession -SqlInstance sql2016 -Session system_health | Get-DbaXESessionTarget -Target package0.event_file" }
