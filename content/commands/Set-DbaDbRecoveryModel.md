...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaDbRecoveryModel</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaDbRecoveryModel.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Viorel Ciucu (@viorelciucu), cviorel.com</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbRecoveryModel -SqlInstance sql2014 -RecoveryModel BulkLogged -Database model -Confirm:$true -Verbose" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2014 -Database TestDB | Set-DbaDbRecoveryModel -RecoveryModel Simple  -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbRecoveryModel -SqlInstance sql2014 -RecoveryModel Simple -Database TestDB -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbRecoveryModel -SqlInstance sql2014 -RecoveryModel Simple -AllDatabases -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbRecoveryModel -SqlInstance sql2014 -RecoveryModel BulkLogged -Database TestDB1, TestDB2 -Confirm:$false -Verbose" }
