...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaRunningJob</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaRunningJob.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaRunningJob -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentJob -SqlInstance sql2017, sql2019 | Get-DbaRunningJob" }
...
```
{: data-copyable="true" data-clean-code="$servers | Get-DbaRunningJob" }
