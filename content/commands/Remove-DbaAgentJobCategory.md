...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaAgentJobCategory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAgentJobCategory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgentJobCategory -SqlInstance sql1 -Category 'Category 1'" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgentJobCategory -SqlInstance sql1 -Category Category1, Category2, Category3" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgentJobCategory -SqlInstance sql1, sql2, sql3 -Category Category1, Category2, Category3" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentJobCategory -SqlInstance SRV1 | Out-GridView -Title 'Select SQL Agent job category(-ies) to drop' -OutputMode Multiple | Remove-DbaAgentJobCategory" }
