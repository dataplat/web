...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPbmStore</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPbmStore.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmStore -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmStore -SqlInstance sql2016 -SqlCredential $cred" }
