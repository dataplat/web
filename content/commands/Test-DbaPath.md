...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaPath</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaPath.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaPath -SqlInstance sqlcluster -Path L:\MSAS12.MSSQLSERVER\OLAP" }
