...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaReplDistributor</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaReplDistributor.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>William Durkin (@sql_williamd)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplDistributor -SqlInstance sql2008, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Connect-DbaInstance -SqlInstance mssql1 | Get-DbaReplDistributor" }
