...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbCompression</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbCompression.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbCompression -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbCompression -SqlInstance localhost -Database TestDatabase" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbCompression -SqlInstance localhost -ExcludeDatabase TestDatabases" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbCompression -SqlInstance localhost -ExcludeDatabase TestDatabases -Table table1, table2" }
