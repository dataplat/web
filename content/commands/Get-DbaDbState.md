...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbState</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbState.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbState -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbState -SqlInstance sqlserver2014a -Database HR, Accounting" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbState -SqlInstance sqlserver2014a -Exclude HR" }
...
```
{: data-copyable="true" data-clean-code="'sqlserver2014a', 'sqlserver2014b' | Get-DbaDbState" }
