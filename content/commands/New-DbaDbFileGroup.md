...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbFileGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbFileGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -FileGroupType FileStreamDataFileGroup" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -FileGroupType MemoryOptimizedDataFileGroup" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sqldev1 -Database TestDb | New-DbaDbFileGroup -FileGroup HRFG1" }
