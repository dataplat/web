...
<div class="command-header">
  <div class="command-header-top">
    <h1>Show-DbaInstanceFileSystem</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Show-DbaInstanceFileSystem.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Show-DbaInstanceFileSystem -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Show-DbaInstanceFileSystem -SqlInstance sql2017 -SqlCredential $cred" }
