...
<div class="command-header">
  <div class="command-header-top">
    <h1>Update-Dbatools</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Update-Dbatools.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Update-Dbatools" }
...
```
{: data-copyable="true" data-clean-code="Update-Dbatools -dev" }
