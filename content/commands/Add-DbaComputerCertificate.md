...
Want to see the source code for this command? Check out [Add-DbaComputerCertificate](https://github.com/dataplat/dbatools/blob/master/public/Add-DbaComputerCertificate.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Add-DbaComputerCertificate](https://dataplat.github.io/boh#Add-DbaComputerCertificate).
