...
<div class="command-header">
  <div class="command-header-top">
    <h1>Find-DbaView</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Find-DbaView.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Find-DbaView -SqlInstance DEV01 -Pattern whatever" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaView -SqlInstance sql2016 -Pattern '\w+@\w+\.\w+'" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaView -SqlInstance DEV01 -Database MyDB -Pattern 'some string' -Verbose" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaView -SqlInstance sql2016 -Database MyDB -Pattern RUNTIME -IncludeSystemObjects" }
