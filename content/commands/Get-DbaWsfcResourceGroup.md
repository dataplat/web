...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaWsfcResourceGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaWsfcResourceGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaWsfcResourceGroup -ComputerName cluster01" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaWsfcResourceGroup -ComputerName cluster01 | Select-Object *" }
