...
<div class="command-header">
  <div class="command-header-top">
    <h1>Resolve-DbaPath</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Resolve-DbaPath.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Resolve-DbaPath -Path report.log -Provider FileSystem -NewChild -SingleItem" }
...
```
{: data-copyable="true" data-clean-code="Resolve-DbaPath -Path ..\*" }
