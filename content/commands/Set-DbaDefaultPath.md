...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaDefaultPath</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaDefaultPath.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Set-DbaDefaultPath -SqlInstance sql01\sharepoint -Type Data, Backup -Path C:\mssql\sharepoint\data" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDefaultPath -SqlInstance sql01\sharepoint -Type Data, Log -Path C:\mssql\sharepoint\data -WhatIf" }
