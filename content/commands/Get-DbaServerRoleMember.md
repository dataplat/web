...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaServerRoleMember</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaServerRoleMember.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance localhost, sql2016" }
...
$servers | Get-DbaServerRoleMember" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance localhost -ServerRole 'sysadmin', 'dbcreator'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance localhost -ExcludeServerRole 'sysadmin'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance sql2017a -ExcludeFixedRole" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRoleMember -SqlInstance localhost -Login 'MyFriendlyDeveloper'" }
