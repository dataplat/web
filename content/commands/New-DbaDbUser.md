...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbUser</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbUser.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Frank Henninger (@osiris687) , Andreas Jordan (@JordanOrdix), ordix.de</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -Login user1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -User user1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -User user1 -Login login1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -User user1 -Login Login1 -DefaultSchema schema1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -User &quot;claudio@********.onmicrosoft.com&quot; -ExternalProvider" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbUser -SqlInstance sqlserver2014 -Database DB1 -Username user1 -Password (ConvertTo-SecureString -String &quot;DBATools&quot; -AsPlainText -Force)" }
