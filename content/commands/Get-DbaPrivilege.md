...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPrivilege</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPrivilege.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPrivilege -ComputerName sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="'sql1','sql2','sql3' | Get-DbaPrivilege" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPrivilege -ComputerName sql1,sql2 | Out-GridView" }
