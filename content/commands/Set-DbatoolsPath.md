...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbatoolsPath</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbatoolsPath.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Set-DbatoolsPath -Name 'temp' -Path 'C:\temp'" }
