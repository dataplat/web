...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaRandomizedType</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaRandomizedType.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaRandomizedType" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRandomizedType -Pattern &quot;Addr&quot;" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRandomizedType -RandomizedType Person" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRandomizedType -RandomizedSubType LastName" }
