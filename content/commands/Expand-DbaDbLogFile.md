...
Want to see the source code for this command? Check out [Expand-DbaDbLogFile](https://github.com/dataplat/dbatools/blob/master/public/Expand-DbaDbLogFile.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Expand-DbaDbLogFile](https://dataplat.github.io/boh#Expand-DbaDbLogFile).
