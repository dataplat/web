...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAgentOperator</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAgentOperator.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentOperator -SqlInstance ServerA,ServerB\instanceB" }
...
```
{: data-copyable="true" data-clean-code="'ServerA','ServerB\instanceB' | Get-DbaAgentOperator" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentOperator -SqlInstance ServerA -Operator Dba1,Dba2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentOperator -SqlInstance ServerA,ServerB -ExcludeOperator Dba3" }
