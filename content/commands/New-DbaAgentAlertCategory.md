...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaAgentAlertCategory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaAgentAlertCategory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaAgentAlertCategory -SqlInstance sql1 -Category 'Category 1'" }
...
```
{: data-copyable="true" data-clean-code="'sql1' | New-DbaAgentAlertCategory -Category 'Category 2'" }
