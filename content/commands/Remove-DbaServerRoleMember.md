...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaServerRoleMember</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaServerRoleMember.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRoleMember -SqlInstance server1 -ServerRole dbcreator -Login login1" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRoleMember -SqlInstance server1, sql2016 -ServerRole customrole -Login login1" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRoleMember -SqlInstance server1 -ServerRole customrole -Role dbcreator" }
...
$servers | Remove-DbaServerRoleMember -ServerRole sysadmin -Login login1" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRoleMember -SqlInstance localhost -ServerRole bulkadmin, dbcreator -Login login1" }
