...
<div class="command-header">
  <div class="command-header-top">
    <h1>Invoke-DbaBalanceDataFiles</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbaBalanceDataFiles.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaBalanceDataFiles -SqlInstance sql1 -Database db1" }
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaBalanceDataFiles -SqlInstance sql1 -Database db1 | Select-Object -ExpandProperty DataFilesEnd" }
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaBalanceDataFiles -SqlInstance sql1 -Database db1 -Table table1,table2,table5" }
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaBalanceDataFiles -SqlInstance sql1 -Database db1 -RebuildOffline" }
