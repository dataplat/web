...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaExtendedProperty</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaExtendedProperty.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaExtendedProperty -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaExtendedProperty -SqlInstance Server1 -Database db1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaExtendedProperty -SqlInstance Server1 -Database db1 -Name info1, info2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbStoredProcedure -SqlInstance localhost -Database tempdb | Get-DbaExtendedProperty" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbTable -SqlInstance localhost -Database mydb -Table mytable | Get-DbaExtendedProperty" }
