...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaMaxMemory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaMaxMemory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaMaxMemory -SqlInstance sqlcluster, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sqlcluster | Get-DbaMaxMemory | Where-Object { $_.MaxValue -gt $_.Total }" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaInstance -ComputerName localhost | Get-DbaMaxMemory | Format-Table -AutoSize" }
