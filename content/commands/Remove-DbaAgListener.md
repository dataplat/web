...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaAgListener</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAgListener.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgListener -SqlInstance sqlserver2012 -AvailabilityGroup ag1, ag2 -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2012 -AvailabilityGroup availabilitygroup1 | Remove-DbaAgListener" }
