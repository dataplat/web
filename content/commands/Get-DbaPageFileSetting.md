...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPageFileSetting</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPageFileSetting.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPageFileSetting -ComputerName ServerA,ServerB" }
...
```
{: data-copyable="true" data-clean-code="'ServerA' | Get-DbaPageFileSetting" }
