...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbccHelp</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbccHelp.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbccHelp -SqlInstance SQLInstance -Statement FREESYSTEMCACHE -Verbose | Format-List" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbccHelp -SqlInstance SQLInstance -Statement WritePage -IncludeUndocumented | Format-List" }
