...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaFilestream</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaFilestream.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaFilestream -SqlInstance server1\instance2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaFilestream -SqlInstance server1\instance2 -SqlCredential sqladmin" }
