...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaReplPublication</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaReplPublication.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaReplPublication -SqlInstance mssql1 -Database Northwind -Name PubFromPosh" }
