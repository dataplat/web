...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbEncryptionKey</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbEncryptionKey.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="$dbs = Get-DbaDatabase -SqlInstance sql01 -Database pubs
$db | New-DbaDbEncryptionKey" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbEncryptionKey -SqlInstance sql01 -Database db1 -EncryptorName &quot;sql01 cert&quot; -EncryptionAlgorithm Aes192 -Confirm:$false" }
