...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaReplPublisher</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaReplPublisher.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaReplPublisher -SqlInstance mssql1" }
...
```
{: data-copyable="true" data-clean-code="Connect-DbaInstance -SqlInstance mssql1 |  Get-DbaReplPublisher" }
