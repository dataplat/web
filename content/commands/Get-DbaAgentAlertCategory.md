...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAgentAlertCategory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAgentAlertCategory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentAlertCategory -SqlInstance sql1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentAlertCategory -SqlInstance sql1 -Category 'Severity Alert'" }
