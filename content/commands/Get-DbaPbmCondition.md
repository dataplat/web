...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPbmCondition</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPbmCondition.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmCondition -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmCondition -SqlInstance sql2016 -SqlCredential $cred" }
