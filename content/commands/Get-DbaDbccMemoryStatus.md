...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbccMemoryStatus</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbccMemoryStatus.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbccMemoryStatus -SqlInstance sqlcluster, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sqlcluster | Get-DbaDbccMemoryStatus" }
