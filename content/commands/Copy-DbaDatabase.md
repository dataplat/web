...
Want to see the source code for this command? Check out [Copy-DbaDatabase](https://github.com/dataplat/dbatools/blob/master/public/Copy-DbaDatabase.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Copy-DbaDatabase](https://dataplat.github.io/boh#Copy-DbaDatabase).
