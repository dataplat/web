...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaInstanceUserOption</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaInstanceUserOption.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaInstanceUserOption -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaInstanceUserOption -SqlInstance sql2, sql4\sqlexpress" }
...
```
{: data-copyable="true" data-clean-code="'sql2','sql4' | Get-DbaInstanceUserOption" }
