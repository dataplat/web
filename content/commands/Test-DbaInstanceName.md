...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaInstanceName</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaInstanceName.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaInstanceName -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaInstanceName -SqlInstance sqlserver2014a, sql2016" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaInstanceName -SqlInstance sqlserver2014a, sql2016 -ExcludeSsrs" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaInstanceName -SqlInstance sqlserver2014a, sql2016 | Select-Object *" }
