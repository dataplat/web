...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaReplSubscription</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaReplSubscription.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="$sub = @{
SqlInstance           = 'mssql1'
Database              = 'pubs'
PublicationName       = 'testPub'
SubscriberSqlInstance = 'mssql2'
