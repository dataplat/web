...
Want to see the source code for this command? Check out [Copy-DbaDbAssembly](https://github.com/dataplat/dbatools/blob/master/public/Copy-DbaDbAssembly.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Copy-DbaDbAssembly](https://dataplat.github.io/boh#Copy-DbaDbAssembly).
