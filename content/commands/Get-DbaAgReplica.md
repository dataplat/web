...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAgReplica</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAgReplica.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgReplica -SqlInstance sql2017a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgReplica -SqlInstance sql2017a -AvailabilityGroup SharePoint" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgReplica -SqlInstance sql2017a | Select-Object *" }
