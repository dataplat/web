...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbAssembly</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbAssembly.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbAssembly -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbAssembly -SqlInstance localhost, sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbAssembly -SqlInstance Server1 -Database MyDb -Name MyTechCo.Houids.SQLCLR" }
