...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbFileGrowth</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbFileGrowth.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbFileGrowth -SqlInstance sql2017, sql2016, sql2012" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbFileGrowth -SqlInstance sql2017, sql2016, sql2012 -Database pubs" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2016 -Database test | Get-DbaDbFileGrowth" }
