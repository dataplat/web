...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaForceNetworkEncryption</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaForceNetworkEncryption.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaForceNetworkEncryption" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaForceNetworkEncryption -SqlInstance sql01\SQL2008R2SP2" }
