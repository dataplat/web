...
<div class="command-header">
  <div class="command-header-top">
    <h1>Import-DbaCsv</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Import-DbaCsv.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path C:\temp\housing.csv -SqlInstance sql001 -Database markets" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path .\housing.csv -SqlInstance sql001 -Database markets -Table housing -Delimiter &quot;`t&quot; -NoHeaderRow" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path C:\temp\huge.txt -SqlInstance sqlcluster -Database locations -Table latitudes -Delimiter &quot;|&quot;" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path c:\temp\SingleColumn.csv -SqlInstance sql001 -Database markets -Table TempTable -SingleColumn" }
...
```
{: data-copyable="true" data-clean-code="Get-ChildItem -Path \\FileServer\csvs | Import-DbaCsv -SqlInstance sql001, sql002 -Database tempdb -AutoCreateTable" }
...
```
{: data-copyable="true" data-clean-code="Get-ChildItem -Path \\FileServer\csvs | Import-DbaCsv -SqlInstance sql001, sql002 -Database tempdb -AutoCreateTable -WhatIf" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path c:\temp\dataset.csv -SqlInstance sql2016 -Database tempdb -Column Name, Address, Mobile" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path C:\temp\schema.data.csv -SqlInstance sql2016 -database tempdb -UseFileNameForSchema" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaCsv -Path C:\temp\schema.data.csv -SqlInstance sql2016 -database tempdb -UseFileNameForSchema -Table testtable" }
...
```
{: data-copyable="true" data-clean-code="$columns = @{
Text = 'FirstName'
Number = 'PhoneNumber'
}
Import-DbaCsv -Path c:\temp\supersmall.csv -SqlInstance sql2016 -Database tempdb -ColumnMap $columns" }
...
Import-DbaCsv -Path c:\temp\supersmall.csv -SqlInstance sql2016 -Database tempdb -NoHeaderRow -ColumnMap $columns" }
