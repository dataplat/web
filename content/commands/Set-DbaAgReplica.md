...
Want to see the source code for this command? Check out [Set-DbaAgReplica](https://github.com/dataplat/dbatools/blob/master/public/Set-DbaAgReplica.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Set-DbaAgReplica](https://dataplat.github.io/boh#Set-DbaAgReplica).
