...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaResourceGovernor</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaResourceGovernor.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaResourceGovernor -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="'Sql1','Sql2/sqlexpress' | Get-DbaResourceGovernor" }
