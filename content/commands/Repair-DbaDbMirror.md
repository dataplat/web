...
<div class="command-header">
  <div class="command-header-top">
    <h1>Repair-DbaDbMirror</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Repair-DbaDbMirror.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Repair-DbaDbMirror -SqlInstance sql2017 -Database pubs" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2017 -Database pubs | Repair-DbaDbMirror -Confirm:$false" }
