...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaDbCollation</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaDbCollation.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbCollation -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbCollation -SqlInstance sqlserver2014a -Database db1, db2" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbCollation -SqlInstance sqlserver2014a, sql2016 -Exclude db1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sql2016 | Test-DbaDbCollation" }
