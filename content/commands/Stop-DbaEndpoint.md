...
<div class="command-header">
  <div class="command-header-top">
    <h1>Stop-DbaEndpoint</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Stop-DbaEndpoint.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Stop-DbaEndpoint -SqlInstance sql2017a -AllEndpoints" }
...
```
{: data-copyable="true" data-clean-code="Stop-DbaEndpoint -SqlInstance sql2017a -Endpoint endpoint1,endpoint2" }
...
```
{: data-copyable="true" data-clean-code="Get-Endpoint -SqlInstance sql2017a -Endpoint endpoint1 | Stop-DbaEndpoint" }
