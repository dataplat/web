...
Want to see the source code for this command? Check out [Set-DbaTempDbConfig](https://github.com/dataplat/dbatools/blob/master/public/Set-DbaTempDbConfig.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Set-DbaTempDbConfig](https://dataplat.github.io/boh#Set-DbaTempDbConfig).
