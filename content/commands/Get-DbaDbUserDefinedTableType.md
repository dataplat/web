...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbUserDefinedTableType</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbUserDefinedTableType.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbUserDefinedTableType -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbUserDefinedTableType -SqlInstance Server1 -Database db1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbUserDefinedTableType -SqlInstance Server1 -Database db1 -Type type1" }
