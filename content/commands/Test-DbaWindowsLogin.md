...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaWindowsLogin</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaWindowsLogin.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Stephen Bennett, sqlnotesfromtheunderground.wordpress.com , Chrissy LeMaire (@cl)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Test-DbaWindowsLogin -SqlInstance Dev01" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaWindowsLogin -SqlInstance Dev01 -FilterBy GroupsOnly | Select-Object -Property *" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaWindowsLogin -SqlInstance Dev01 -IgnoreDomains testdomain" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaLogin -SqlInstance Dev01 -Login DOMAIN\User | Test-DbaWindowsLogin" }
