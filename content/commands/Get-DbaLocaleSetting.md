...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaLocaleSetting</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaLocaleSetting.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaLocaleSetting -ComputerName sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="'sql1','sql2','sql3' | Get-DbaLocaleSetting" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaLocaleSetting -ComputerName sql1,sql2 -Credential $credential" }
