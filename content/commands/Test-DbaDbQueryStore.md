...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaDbQueryStore</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaDbQueryStore.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbQueryStore -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbQueryStore -SqlInstance localhost -Database AdventureWorks2017" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbQueryStore -SqlInstance localhost -ExcludeDatabase AdventureWorks2017" }
...
```
{: data-copyable="true" data-clean-code="$databases = Get-DbaDatabase -SqlInstance localhost
$databases | Test-DbaDbQueryStore" }
