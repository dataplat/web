...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaNetworkConfiguration</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaNetworkConfiguration.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaNetworkConfiguration -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaNetworkConfiguration -SqlInstance winserver\sqlexpress, sql2016 -OutputType ServerProtocols" }
