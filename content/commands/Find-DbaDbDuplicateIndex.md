...
<div class="command-header">
  <div class="command-header-top">
    <h1>Find-DbaDbDuplicateIndex</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Find-DbaDbDuplicateIndex.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Find-DbaDbDuplicateIndex -SqlInstance sql2005" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaDbDuplicateIndex -SqlInstance sql2017 -SqlCredential sqladmin" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaDbDuplicateIndex -SqlInstance sql2017 -Database db1, db2" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaDbDuplicateIndex -SqlInstance sql2017 -IncludeOverlapping" }
