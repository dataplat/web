...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaTempDbConfig</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaTempDbConfig.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaTempDbConfig -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaTempDbConfig -SqlInstance localhost | Select-Object *" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sqlserver2014a | Test-DbaTempDbConfig | Select-Object * | Out-GridView" }
