...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaDbDataMaskingConfig</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaDbDataMaskingConfig.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaDbDataMaskingConfig -FilePath C:\temp\_datamasking\db1.json" }
