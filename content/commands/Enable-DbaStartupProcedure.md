...
<div class="command-header">
  <div class="command-header-top">
    <h1>Enable-DbaStartupProcedure</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Enable-DbaStartupProcedure.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Enable-DbaStartupProcedure -SqlInstance SqlBox1\Instance2 -StartupProcedure '[dbo].[StartUpProc1]'" }
...
Enable-DbaStartupProcedure -SqlInstance winserver\sqlexpress, sql2016 -SqlCredential $cred -StartupProcedure '[dbo].[StartUpProc1]'" }
