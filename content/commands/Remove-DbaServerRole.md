...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaServerRole</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaServerRole.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRole -SqlInstance Server1 -ServerRole 'serverExecuter'" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaServerRole -SqlInstance Server1 -ServerRole 'serverExecuter' -Confirm:$false" }
