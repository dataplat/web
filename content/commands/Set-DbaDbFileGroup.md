...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaDbFileGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaDbFileGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -Default -AutoGrowAllFiles" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -AutoGrowAllFiles:$false" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -ReadOnly" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 -ReadOnly:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sqldev1 -Database TestDb | Set-DbaDbFileGroup -FileGroup HRFG1 -AutoGrowAllFiles" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbFileGroup -SqlInstance sqldev1 -Database TestDb -FileGroup HRFG1 | Set-DbaDbFileGroup -AutoGrowAllFiles" }
