...
Want to see the source code for this command? Check out [Install-DbaInstance](https://github.com/dataplat/dbatools/blob/master/public/Install-DbaInstance.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Install-DbaInstance](https://dataplat.github.io/boh#Install-DbaInstance).
