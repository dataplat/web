...
<div class="command-header">
  <div class="command-header-top">
    <h1>Stop-DbaDbEncryption</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Stop-DbaDbEncryption.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Stop-DbaDbEncryption -SqlInstance sql01" }
...
```
{: data-copyable="true" data-clean-code="Stop-DbaDbEncryption -SqlInstance sql01 -Confirm:$false" }
