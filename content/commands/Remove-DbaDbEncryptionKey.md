...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbEncryptionKey</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbEncryptionKey.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbEncryptionKey -SqlInstance sql01 -Database test" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbEncryptionKey -SqlInstance sql01 -Database db1 -Confirm:$false" }
