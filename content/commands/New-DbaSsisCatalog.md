...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaSsisCatalog</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaSsisCatalog.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Stephen Bennett, https://sqlnotesfromtheunderground.wordpress.com/</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="$SecurePassword = Read-Host -AsSecureString -Prompt &quot;Enter password&quot;
...
```
{: data-copyable="true" data-clean-code="New-DbaSsisCatalog -SqlInstance sql2016 -Credential usernamedoesntmatter" }
