...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbQueryStoreOption</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbQueryStoreOption.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Enrico van de Laar (@evdlaar) , Klaas Vandenberghe (@PowerDBAKlaas) , Tracy Boggiano (@TracyBoggiano)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbQueryStoreOption -SqlInstance ServerA\sql" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbQueryStoreOption -SqlInstance ServerA\sql | Where-Object {$_.ActualState -eq &quot;ReadWrite&quot;}" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbQueryStoreOption -SqlInstance localhost | format-table -AutoSize -Wrap" }
