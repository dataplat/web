...
<div class="command-header">
  <div class="command-header-top">
    <h1>Disable-DbaTraceFlag</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Disable-DbaTraceFlag.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Disable-DbaTraceFlag -SqlInstance sql2016 -TraceFlag 3226" }
