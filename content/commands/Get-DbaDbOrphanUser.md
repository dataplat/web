...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbOrphanUser</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbOrphanUser.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Claudio Silva (@ClaudioESSilva) , Garry Bargsley (@gbargsley) , Simone Bizzotto (@niphlod)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbOrphanUser -SqlInstance localhost\sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbOrphanUser -SqlInstance localhost\sql2016 -SqlCredential $cred" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbOrphanUser -SqlInstance localhost\sql2016 -Database db1" }
