...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaXESession</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaXESession.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
PS C:\> $session.Create()
```
{: data-copyable="true" data-clean-code="$session = New-DbaXESession -SqlInstance sql2017 -Name XeSession_Test
