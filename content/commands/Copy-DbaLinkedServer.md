...
Want to see the source code for this command? Check out [Copy-DbaLinkedServer](https://github.com/dataplat/dbatools/blob/master/public/Copy-DbaLinkedServer.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Copy-DbaLinkedServer](https://dataplat.github.io/boh#Copy-DbaLinkedServer).
