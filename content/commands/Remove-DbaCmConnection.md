...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaCmConnection</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaCmConnection.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaCmConnection -ComputerName sql2014" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaCmConnection | Remove-DbaCmConnection" }
