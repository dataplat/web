...
Want to see the source code for this command? Check out [Invoke-DbaDbLogShipping](https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbaDbLogShipping.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Invoke-DbaDbLogShipping](https://dataplat.github.io/boh#Invoke-DbaDbLogShipping).
