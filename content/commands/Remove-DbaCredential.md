...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaCredential</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaCredential.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaCredential -SqlInstance localhost, localhost\namedinstance" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaCredential -SqlInstance localhost -Credential MyDatabaseCredential" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaCredential -SqlInstance SRV1 | Out-GridView -Title 'Select SQL credential(s) to drop' -OutputMode Multiple | Remove-DbaCredential" }
