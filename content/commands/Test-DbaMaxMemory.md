...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaMaxMemory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaMaxMemory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaMaxMemory -SqlInstance sqlcluster,sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sqlcluster | Test-DbaMaxMemory" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sqlcluster | Test-DbaMaxMemory | Where-Object { $_.MaxValue -gt $_.Total } | Set-DbaMaxMemory" }
