...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaExtendedProperty</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaExtendedProperty.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance localhost -Database mydb | Get-DbaExtendedProperty -Name appversion | Set-DbaExtendedProperty -Value &quot;1.1.0&quot;" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbTable -SqlInstance localhost -Database mydb -Table mytable | Get-DbaExtendedProperty -Name appversion | Set-DbaExtendedProperty -Value &quot;1.1.0&quot;" }
