...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAgentAlert</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAgentAlert.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentAlert -SqlInstance ServerA,ServerB\instanceB" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentAlert -SqlInstance ServerA,ServerB\instanceB -Alert MyAlert*" }
...
```
{: data-copyable="true" data-clean-code="'serverA','serverB\instanceB' | Get-DbaAgentAlert" }
