...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbMirror</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbMirror.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbMirror -SqlInstance localhost -Database TestDB" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbMirror -SqlInstance localhost -Database TestDB1, TestDB2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance localhost -Database TestDB1, TestDB2 | Remove-DbaDbMirror" }
