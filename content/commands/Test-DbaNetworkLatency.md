...
<div class="command-header">
  <div class="command-header-top">
    <h1>Test-DbaNetworkLatency</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Test-DbaNetworkLatency.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Test-DbaNetworkLatency -SqlInstance sqlserver2014a, sqlcluster" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaNetworkLatency -SqlInstance sqlserver2014a -SqlCredential $cred" }
...
```
{: data-copyable="true" data-clean-code="Test-DbaNetworkLatency -SqlInstance sqlserver2014a, sqlcluster, sqlserver -Query &quot;select top 10 * from otherdb.dbo.table&quot; -Count 10" }
