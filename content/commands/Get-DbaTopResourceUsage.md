...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaTopResourceUsage</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaTopResourceUsage.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaTopResourceUsage -SqlInstance sql2008, sql2012" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTopResourceUsage -SqlInstance sql2008 -Type Duration, Frequency -Database TestDB" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTopResourceUsage -SqlInstance sql2016 -Limit 30" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTopResourceUsage -SqlInstance sql2008, sql2012 -ExcludeSystem" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTopResourceUsage -SqlInstance sql2016| Select-Object *" }
