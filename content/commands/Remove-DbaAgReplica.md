...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaAgReplica</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAgReplica.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgReplica -SqlInstance sql2017a -AvailabilityGroup SharePoint -Replica sp1" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgReplica -SqlInstance sql2017a | Select-Object *" }
