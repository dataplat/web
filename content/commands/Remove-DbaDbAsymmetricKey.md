...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbAsymmetricKey</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbAsymmetricKey.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbAsymmetricKey -SqlInstance Server1 -Database Enctest -Name AsCert1" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbAsymmetricKey -SqlInstance Server1 -Database Enctest  | Remove-DbaDbAsymmetricKey" }
