...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbPartitionScheme</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbPartitionScheme.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbPartitionScheme -SqlInstance localhost, sql2016 -Database db1, db2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbPartitionScheme -SqlInstance SRV1 | Out-GridView -Title 'Select partition scheme(s) to drop' -OutputMode Multiple | Remove-DbaDbPartitionScheme" }
