...
<div class="command-header">
  <div class="command-header-top">
    <h1>Dismount-DbaDatabase</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Dismount-DbaDatabase.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Detach-DbaDatabase -SqlInstance sql2016b -Database SharePoint_Config, WSS_Logging" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2016b -Database 'PerformancePoint Service Application_10032db0fa0041df8f913f558a5dc0d4' | Detach-DbaDatabase -Force" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2016b -Database WSS_Logging | Detach-DbaDatabase -Force -WhatIf" }
