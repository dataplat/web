...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbMemoryUsage</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbMemoryUsage.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMemoryUsage -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMemoryUsage -SqlInstance sqlserver2014a -IncludeSystemDb" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMemoryUsage -SqlInstance sql1 -IncludeSystemDb -Database tempdb" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMemoryUsage -SqlInstance sql2 -IncludeSystemDb -Exclude 'master','model','msdb','ResourceDb'" }
