...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaRgWorkloadGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaRgWorkloadGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaRgWorkloadGroup -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaResourceGovernor -SqlInstance sql2017 | Get-DbaRgResourcePool | Get-DbaRgWorkloadGroup" }
