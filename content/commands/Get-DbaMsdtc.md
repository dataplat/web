...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaMsdtc</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaMsdtc.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaMsdtc -ComputerName srv0042" }
...
```
{: data-copyable="true" data-clean-code="$Computers = (Get-Content D:\configfiles\SQL\MySQLInstances.txt | % {$_.split('\')[0]})
...
```
{: data-copyable="true" data-clean-code="Get-DbaMsdtc -Computername $Computers | Where-Object { $_.dtcservicestate -ne 'running' }" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaMsdtc -ComputerName srv0042 | Out-Gridview" }
