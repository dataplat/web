...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPfAvailableCounter</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPfAvailableCounter.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPfAvailableCounter" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPfAvailableCounter -Pattern *sql*" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPfAvailableCounter -ComputerName sql2017 -Pattern *sql*" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPfAvailableCounter -Pattern *sql* | Add-DbaPfDataCollectorCounter -CollectorSet 'Test Collector Set' -Collector DataCollector01" }
