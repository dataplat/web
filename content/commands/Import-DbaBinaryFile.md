...
Want to see the source code for this command? Check out [Import-DbaBinaryFile](https://github.com/dataplat/dbatools/blob/master/public/Import-DbaBinaryFile.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Import-DbaBinaryFile](https://dataplat.github.io/boh#Import-DbaBinaryFile).
