...
<div class="command-header">
  <div class="command-header-top">
    <h1>Export-DbaCredential</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Export-DbaCredential.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Export-DbaCredential -SqlInstance sql2017 -Path C:\temp\cred.sql" }
