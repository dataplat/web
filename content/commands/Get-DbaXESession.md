...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaXESession</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaXESession.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaXESession -SqlInstance ServerA\sql987" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaXESession -SqlInstance ServerA\sql987 | Format-Table ComputerName, SqlInstance, Session, Status -AutoSize" }
...
```
{: data-copyable="true" data-clean-code="'ServerA\sql987','ServerB' | Get-DbaXESession" }
