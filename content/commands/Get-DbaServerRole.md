...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaServerRole</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaServerRole.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRole -SqlInstance sql2016a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaServerRole -SqlInstance sql2017a -ExcludeFixedRole" }
