...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbRole</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbRole.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRole -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRole -SqlInstance localhost, sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRole -SqlInstance localhost -Database msdb" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRole -SqlInstance localhost -Database msdb -ExcludeFixedRole" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbRole -SqlInstance localhost -Database msdb -Role 'db_owner'" }
