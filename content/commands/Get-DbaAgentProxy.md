...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAgentProxy</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAgentProxy.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentProxy -SqlInstance ServerA,ServerB\instanceB" }
...
```
{: data-copyable="true" data-clean-code="'serverA','serverB\instanceB' | Get-DbaAgentProxy" }
