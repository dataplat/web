...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaAgDatabase</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAgDatabase.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgDatabase -SqlInstance sqlserver2012 -AvailabilityGroup ag1, ag2 -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAgDatabase -SqlInstance sqlserver2012 -AvailabilityGroup ag1 -Database pubs -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2012 -AvailabilityGroup availabilitygroup1 | Remove-DbaAgDatabase" }
