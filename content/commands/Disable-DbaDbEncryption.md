...
<div class="command-header">
  <div class="command-header-top">
    <h1>Disable-DbaDbEncryption</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Disable-DbaDbEncryption.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Disable-DbaDbEncryption -SqlInstance sql2017, sql2016 -Database pubs" }
...
```
{: data-copyable="true" data-clean-code="Disable-DbaDbEncryption -SqlInstance sql2017 -Database db1 -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2017 -Database db1 | Disable-DbaDbEncryption -Confirm:$false" }
