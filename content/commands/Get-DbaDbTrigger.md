...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbTrigger</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbTrigger.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbTrigger -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDatabase -SqlInstance sql2017 -Database supa | Get-DbaDbTrigger" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbTrigger -SqlInstance sql2017 -Database supa" }
