...
<div class="command-header">
  <div class="command-header-top">
    <h1>Resume-DbaAgDbDataMovement</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Resume-DbaAgDbDataMovement.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Resume-DbaAgDbDataMovement -SqlInstance sql2017a -AvailabilityGroup ag1 -Database db1, db2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgDatabase -SqlInstance sql2017a, sql2019 | Out-GridView -Passthru | Resume-DbaAgDbDataMovement -Confirm:$false" }
