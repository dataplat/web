...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPlanCache</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPlanCache.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPlanCache -SqlInstance sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPlanCache -SqlInstance sql2017 -SqlCredential sqladmin" }
