...
<div class="command-header">
  <div class="command-header-top">
    <h1>Invoke-DbaDbccDropCleanBuffer</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Invoke-DbaDbccDropCleanBuffer.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaDbccDropCleanBuffer -SqlInstance SqlServer2017" }
...
```
{: data-copyable="true" data-clean-code="Invoke-DbaDbccDropCleanBuffer -SqlInstance SqlServer2017 -NoInformationalMessages" }
...
```
{: data-copyable="true" data-clean-code="'Sql1','Sql2/sqlexpress' | Invoke-DbaDbccDropCleanBuffer -WhatIf" }
...
Invoke-DbaDbccDropCleanBuffer -SqlInstance Server1 -SqlCredential $cred" }
