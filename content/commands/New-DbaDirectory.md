...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDirectory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDirectory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaDirectory -SqlInstance sqlcluster -Path L:\MSAS12.MSSQLSERVER\OLAP" }
...
```
{: data-copyable="true" data-clean-code="$credential = Get-Credential
