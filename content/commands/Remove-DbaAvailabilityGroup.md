...
Want to see the source code for this command? Check out [Remove-DbaAvailabilityGroup](https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAvailabilityGroup.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Remove-DbaAvailabilityGroup](https://dataplat.github.io/boh#Remove-DbaAvailabilityGroup).
