---
title: "Remove-DbaAvailabilityGroup"
slug: "Remove-DbaAvailabilityGroup"
date: 2024-01-01
layout: "single"
...
tags:
  - "AG"
  - "HA"
sourceUrl: "https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAvailabilityGroup.ps1"
bohUrl: "https://dataplat.github.io/boh#Remove-DbaAvailabilityGroup"
draft: false
---
...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaAvailabilityGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaAvailabilityGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAvailabilityGroup -SqlInstance sqlserver2012 -AllAvailabilityGroups" }

Removes all availability groups on the sqlserver2014 instance. Prompts for confirmation.<br>
...
```
{: data-copyable="true" data-clean-code="Remove-DbaAvailabilityGroup -SqlInstance sqlserver2012 -AvailabilityGroup ag1, ag2 -Confirm:$false" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2012 -AvailabilityGroup availabilitygroup1 | Remove-DbaAvailabilityGroup" }
