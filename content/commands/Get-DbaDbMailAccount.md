...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDbMailAccount</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDbMailAccount.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailAccount -SqlInstance sql01\sharepoint" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailAccount -SqlInstance sql01\sharepoint -Account 'The DBA Team'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaDbMailAccount -SqlInstance sql01\sharepoint | Select-Object *" }
