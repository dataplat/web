...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbMasterKey</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbMasterKey.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMasterKey -SqlInstance Server1" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMasterKey -SqlInstance Server1 -Credential usernamedoesntmatter" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMasterKey -SqlInstance Server1 -Database db1 -Confirm:$false" }
