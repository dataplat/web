...
<div class="command-header">
  <div class="command-header-top">
    <h1>Clear-DbaWaitStatistics</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Clear-DbaWaitStatistics.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Clear-DbaWaitStatistics -SqlInstance sql2008, sqlserver2012" }
...
```
{: data-copyable="true" data-clean-code="Clear-DbaWaitStatistics -SqlInstance sql2008, sqlserver2012 -Confirm:$false" }
