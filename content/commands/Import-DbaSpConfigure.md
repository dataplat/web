...
<div class="command-header">
  <div class="command-header-top">
    <h1>Import-DbaSpConfigure</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Import-DbaSpConfigure.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Import-DbaSpConfigure -Source sqlserver -Destination sqlcluster" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaSpConfigure -Source sqlserver -Destination sqlcluster -Force" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaSpConfigure -Source sqlserver -Destination sqlcluster -SourceSqlCredential $SourceSqlCredential -DestinationSqlCredential $DestinationSqlCredential" }
...
```
{: data-copyable="true" data-clean-code="Import-DbaSpConfigure -SqlInstance sqlserver -Path .\spconfig.sql -SqlCredential $SqlCredential" }
