...
<div class="command-header">
  <div class="command-header-top">
    <h1>Enable-DbaReplPublishing</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Enable-DbaReplPublishing.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Enable-DbaReplPublishing -SqlInstance SqlBox1\Instance2" }
