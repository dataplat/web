...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPbmCategory</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPbmCategory.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmCategory -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPbmCategory -SqlInstance sql2016 -SqlCredential $cred" }
