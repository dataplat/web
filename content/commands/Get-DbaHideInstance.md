...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaHideInstance</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaHideInstance.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Tracy Boggiano @TracyBoggiano, databaseuperhero.com</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaHideInstance" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaHideInstance -SqlInstance sql01\SQL2008R2SP2" }
