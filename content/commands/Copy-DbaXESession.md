...
<div class="command-header">
  <div class="command-header-top">
    <h1>Copy-DbaXESession</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Copy-DbaXESession.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Copy-DbaXESession -Source sqlserver2014a -Destination sqlcluster" }
...
```
{: data-copyable="true" data-clean-code="Copy-DbaXESession -Source sqlserver2014a -Destination sqlcluster -SourceSqlCredential $cred" }
...
```
{: data-copyable="true" data-clean-code="Copy-DbaXESession -Source sqlserver2014a -Destination sqlcluster -WhatIf" }
...
```
{: data-copyable="true" data-clean-code="Copy-DbaXESession -Source sqlserver2014a -Destination sqlcluster -XeSession CheckQueries, MonitorUserDefinedException" }
