...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbMirrorMonitor</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbMirrorMonitor.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbMirrorMonitor -SqlInstance sql2008, sql2012" }
