...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaTrace</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaTrace.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaTrace -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaTrace -SqlInstance sql2016 -Default" }
