...
<div class="command-header">
  <div class="command-header-top">
    <h1>Find-DbaLoginInGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Find-DbaLoginInGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Stephen Bennett, sqlnotesfromtheunderground.wordpress.com , Simone Bizzotto (@niphlod)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Find-DbaLoginInGroup -SqlInstance DEV01 -Login &quot;MyDomain\Stephen.Bennett&quot;" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaLoginInGroup -SqlInstance DEV01" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaLoginInGroup -SqlInstance DEV01 | Where-Object Login -like '*stephen*'" }
