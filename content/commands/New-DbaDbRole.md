...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbRole</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbRole.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaDbRole -SqlInstance sql2017a -Database db1 -Role 'dbExecuter'" }
