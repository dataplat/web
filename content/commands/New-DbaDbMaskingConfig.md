...
<div class="command-header">
  <div class="command-header-top">
    <h1>New-DbaDbMaskingConfig</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/New-DbaDbMaskingConfig.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMaskingConfig -SqlInstance SQLDB1 -Database DB1 -Path C:\Temp\clone" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMaskingConfig -SqlInstance SQLDB1 -Database DB1 -Table Customer -Path C:\Temp\clone" }
...
```
{: data-copyable="true" data-clean-code="New-DbaDbMaskingConfig -SqlInstance SQLDB1 -Database DB1 -Table Customer -Column City -Path C:\Temp\clone" }
