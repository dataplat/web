...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaNetworkCertificate</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaNetworkCertificate.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="New-DbaComputerCertificate | Set-DbaNetworkCertificate -SqlInstance localhost\SQL2008R2SP2" }
...
```
{: data-copyable="true" data-clean-code="Set-DbaNetworkCertificate -SqlInstance sql1\SQL2008R2SP2 -Thumbprint 1223FB1ACBCA44D3EE9640F81B6BA14A92F3D6E2" }
