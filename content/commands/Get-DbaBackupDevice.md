...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaBackupDevice</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaBackupDevice.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaBackupDevice -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaBackupDevice -SqlInstance localhost, sql2016" }
