...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaPowerPlan</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaPowerPlan.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaPowerPlan -ComputerName sql2017" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPowerPlan -ComputerName sql2017 -Credential ad\admin" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaPowerPlan -ComputerName sql2017 -List" }
