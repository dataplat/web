...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaStartupProcedure</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaStartupProcedure.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaStartupProcedure -SqlInstance SqlBox1\Instance2" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaStartupProcedure -SqlInstance SqlBox1\Instance2 -StartupProcedure 'dbo.StartupProc'" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaRegServer -SqlInstance sql2014 | Get-DbaStartupProcedure" }
