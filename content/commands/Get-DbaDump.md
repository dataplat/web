...
tags:
  ...
  - "Engine"
  - "Corruption"
sourceUrl: "https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDump.ps1"
bohUrl: "https://dataplat.github.io/boh#Get-DbaDump"
draft: false
---
...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaDump</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaDump.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaDump -SqlInstance sql2016" }

Shows the detailed information for memory dump(s) located on sql2016 instance<br>
...
```
{: data-copyable="true" data-clean-code="Get-DbaDump -SqlInstance sql2016 -SqlCredential sqladmin" }

Shows the detailed information for memory dump(s) located on sql2016 instance. Logs into the SQL Server using the SQL login 'sqladmin'<br>
