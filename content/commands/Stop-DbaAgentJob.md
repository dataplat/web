...
<div class="command-header">
  <div class="command-header-top">
    <h1>Stop-DbaAgentJob</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Stop-DbaAgentJob.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Stop-DbaAgentJob -SqlInstance localhost" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAgentJob -SqlInstance sql2016 -Job cdc.DBWithCDC_capture | Stop-DbaAgentJob" }
...
```
{: data-copyable="true" data-clean-code="Stop-DbaAgentJob -SqlInstance sql2016 -Job cdc.DBWithCDC_capture" }
