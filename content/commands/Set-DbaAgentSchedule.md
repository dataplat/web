...
Want to see the source code for this command? Check out [Set-DbaAgentSchedule](https://github.com/dataplat/dbatools/blob/master/public/Set-DbaAgentSchedule.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Set-DbaAgentSchedule](https://dataplat.github.io/boh#Set-DbaAgentSchedule).
