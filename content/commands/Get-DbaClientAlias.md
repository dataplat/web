...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaClientAlias</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaClientAlias.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaClientAlias" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaClientAlias -ComputerName workstationx" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaClientAlias -ComputerName workstationx -Credential ad\sqldba" }
...
```
{: data-copyable="true" data-clean-code="'Server1', 'Server2' | Get-DbaClientAlias" }
