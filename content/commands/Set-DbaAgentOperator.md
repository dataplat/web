...
Want to see the source code for this command? Check out [Set-DbaAgentOperator](https://github.com/dataplat/dbatools/blob/master/public/Set-DbaAgentOperator.ps1) on GitHub.
<br>
Want to see the Bill Of Health for this command? Check out [Set-DbaAgentOperator](https://dataplat.github.io/boh#Set-DbaAgentOperator).
