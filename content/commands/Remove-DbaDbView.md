...
<div class="command-header">
  <div class="command-header-top">
    <h1>Remove-DbaDbView</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Remove-DbaDbView.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Remove-DbaDbView -SqlInstance localhost, sql2016 -Database db1, db2 -View view1, view2, view3" }
...
```
{: data-copyable="true" data-clean-code="$views = Get-DbaDbView -SqlInstance localhost, sql2016 -Database db1, db2 -View view1, view2, view3
$views | Remove-DbaDbView" }
