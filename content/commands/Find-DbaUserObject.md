...
<div class="command-header">
  <div class="command-header-top">
    <h1>Find-DbaUserObject</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Find-DbaUserObject.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Find-DbaUserObject -SqlInstance DEV01 -Pattern ad\stephen" }
...
```
{: data-copyable="true" data-clean-code="Find-DbaUserObject -SqlInstance DEV01 -Verbose" }
