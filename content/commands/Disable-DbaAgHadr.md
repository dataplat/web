...
<div class="command-header">
  <div class="command-header-top">
    <h1>Disable-DbaAgHadr</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Disable-DbaAgHadr.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Disable-DbaAgHadr -SqlInstance sql2016" }
...
```
{: data-copyable="true" data-clean-code="Disable-DbaAgHadr -SqlInstance sql2016 -Force" }
...
```
{: data-copyable="true" data-clean-code="Disable-DbaAgHadr -SqlInstance sql2012\dev1 -Force" }
