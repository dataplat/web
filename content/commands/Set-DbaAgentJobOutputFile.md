...
<div class="command-header">
  <div class="command-header-top">
    <h1>Set-DbaAgentJobOutputFile</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Set-DbaAgentJobOutputFile.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Rob Sewell, sqldbawithabeard.com</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Set-DbaAgentJobOutputFile -SqlInstance SERVERNAME -Job 'The Agent Job' -OutPutFile E:\Logs\AgentJobStepOutput.txt" }
