...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaAvailabilityGroup</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaAvailabilityGroup.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
  ...
  <div class="command-meta">
    <div class="meta-item">
      ...
      <span>Shawn Melton (@wsmelton) , Chrissy LeMaire (@cl)</span>
    </div>
    <div class="meta-item">
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2014a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2014a -AvailabilityGroup AG-a" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2014a | Select-Object *" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2014a | Select-Object -ExpandProperty PrimaryReplicaServerName" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaAvailabilityGroup -SqlInstance sqlserver2014a -AvailabilityGroup AG-a -IsPrimary" }
