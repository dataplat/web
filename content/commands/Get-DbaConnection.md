...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaConnection</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaConnection.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaConnection -SqlInstance sql2016, sql2017" }
