...
<div class="command-header">
  <div class="command-header-top">
    <h1>Get-DbaCmConnection</h1>
    <a href="https://github.com/dataplat/dbatools/blob/master/public/Get-DbaCmConnection.ps1" target="_blank" rel="noopener noreferrer" class="github-link" title="View source on GitHub">
...
```
{: data-copyable="true" data-clean-code="Get-DbaCmConnection" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaCmConnection sql2014" }
...
```
{: data-copyable="true" data-clean-code="Get-DbaCmConnection -UserName &quot;*charles*&quot;" }
