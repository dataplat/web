...
As part of dbatools participation in this event we are encouraging contributors to assist "the road towards 1.0" by improving the examples available in the comment-based help, which power the new docs site at [docs.dbatools.io](https://dbatools.io).
...
After creating your GitHub account don't forget to [register](https://hacktoberfest.com/sign_up/register) at hacktoberfest if you want your contributions to be recorded and to qualify for a T-Shirt.

## Find the Command You Want to Edit

In this case, we'll add an example to [Get-DbaClientAlias](https://dbatools.io/Get-DbaClientAlias). We can do this by clicking on the **functions** directory.
...
And now they will show up on [docs.dbatools.io](https://dbatools.io)

![](/images/docs.png)

If you'd like more examples, check out Möltz Jensen's last [two](https://github.com/dataplat/dbatools/pull/4161) [pull requests](https://github.com/dataplat/dbatools/pull/4159) where he added some useful examples.
